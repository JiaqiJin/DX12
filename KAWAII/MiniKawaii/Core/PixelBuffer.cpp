...
namespace Rendering
{
	static int GetFormatChannels(DXGI_FORMAT format)
	{
		switch (format)
		{
		default:
	...
	void PixelBuffer::ExportToFile(ID3D12Device* pDevice, const std::wstring& filePath)
	{
		//TODO
	}

	int PixelBuffer::ExportToImage(ID3D12Device* pDevice, const std::string& filePath)
	{
		// TODO
		return 1;
	}
	...
	void PixelBuffer::CreateTextureResource(ID3D12Device* pDevice, const std::wstring& name, 

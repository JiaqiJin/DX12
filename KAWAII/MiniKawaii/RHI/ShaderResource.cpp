...
namespace RHI
{
	...
	{
		// Use the reflection to get the resource that Shader is needed.
		ID3D12ShaderReflection* pShaderReflection;
		ThrowIfFailed(D3DReflect(pShaderBytecode->GetBufferPointer(), pShaderBytecode->GetBufferSize(),
		...
		// TODO: Implement Sampler associated with Texture
		// Assign Sampler Id to Texture SRV
	}

...
namespace RHI
{
	...
	public:
		...
		public:
			...
			static constexpr const UINT32 InvalidRootIndex = static_cast<UINT32>(-1);
			static constexpr const UINT32 InvalidOffset = static_cast<UINT32>(-1);
			
			// ShaderResourceLayout object is stored in unorderedmap, the reference may be invalid
			const ShaderResourceAttribs& Attribs; // Corresponds to a resource in ShaderResource
